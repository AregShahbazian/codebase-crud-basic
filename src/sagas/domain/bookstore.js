...
export const sagas = {
    fetchAll: {
        do: {
            author: makeApiCall.bind(null, routines.AUTHOR.FETCH_ALL, api.author.fetchAuthors)
        },
        watch: {
            author: watchAction.bind(null, routines.AUTHOR.FETCH_ALL.TRIGGER, doFetchAuthors)
        }
    }
}